...
![Last test](https://github.com/andrelohmann/ansible-role-sury_php/actions/workflows/test.yml/badge.svg)

## Content

Use this role to install the deb.sury.org php (7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, 8.3) repository on your ubuntu server.
